    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FormNavigator.redirect(CustomerCheckPhone.this, new CustomerHomePagePanel());
            }
        });
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FormNavigator.redirect(CustomerCheckPhone.this, new CustomerMenuPanel());
            }
        });
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FormNavigator.redirect(CustomerCheckPhone.this, new CustomerProfilePanelVisible());
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 570, 80, 60));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/barkbites/CustomerDesign/CustomerCheckPhone.png")));
