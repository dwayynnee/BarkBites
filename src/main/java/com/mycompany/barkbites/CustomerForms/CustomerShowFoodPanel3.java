...
/*
 * CustomerShowFoodPanel3 — food detail display for item variants (panel 3).
 */
...
public class CustomerShowFoodPanel3 extends javax.swing.JFrame {
        ...
        javax.swing.SwingWorker<MenuCardData, Void> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel3.this, msg, "Menu load failed", JOptionPane.ERROR_MESSAGE);
                }
            }
        };
    ...
    private void addToCart() {
        ...
        javax.swing.SwingWorker<Void, Void> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    get();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel3.this, "Added to cart.", "Cart updated", JOptionPane.INFORMATION_MESSAGE);
                } catch (InterruptedException ie) {
                    Thread.currentThread().interrupt();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel3.this, "Cart save interrupted.", "Add to cart failed", JOptionPane.ERROR_MESSAGE);
                } catch (ExecutionException ee) {
                    String msg = ee.getCause() != null ? ee.getCause().getMessage() : ee.getMessage();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel3.this, msg, "Add to cart failed", JOptionPane.ERROR_MESSAGE);
                } finally {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 570, 100, 50));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("jLabel4");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 80, 30));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 370, 100, 40));

        jButton4.setText("jButton4");
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 560, 310, 70));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/barkbites/CustomerDesign/CustomerShowFoodPanel3.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new CustomerShowFoodPanel3().setVisible(true));
    }
