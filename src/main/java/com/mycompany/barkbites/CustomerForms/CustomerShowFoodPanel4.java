...
/*
 * CustomerShowFoodPanel4 — food detail display for item variants (panel 4).
 */
...
public class CustomerShowFoodPanel4 extends javax.swing.JFrame {

    private static final String MENU_DOCUMENT_ID = "menu-004";
        ...
        javax.swing.SwingWorker<MenuCardData, Void> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel4.this, msg, "Menu load failed", JOptionPane.ERROR_MESSAGE);
                }
            }
        };
    ...
    private void addToCart() {
        ...
        javax.swing.SwingWorker<Void, Void> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    get();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel4.this, "Added to cart.", "Cart updated", JOptionPane.INFORMATION_MESSAGE);
                } catch (InterruptedException ie) {
                    Thread.currentThread().interrupt();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel4.this, "Cart save interrupted.", "Add to cart failed", JOptionPane.ERROR_MESSAGE);
                } catch (ExecutionException ee) {
                    String msg = ee.getCause() != null ? ee.getCause().getMessage() : ee.getMessage();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel4.this, msg, "Add to cart failed", JOptionPane.ERROR_MESSAGE);
                } finally {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jCheckBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 520, -1, 30));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("jLabel3");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 570, 60, 50));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/barkbites/CustomerDesign/CustomerShowFoodPanel4.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new CustomerShowFoodPanel4().setVisible(true));
    }
