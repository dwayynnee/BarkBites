...
public class CustomerShowFoodPanel1 extends javax.swing.JFrame {
        ...
        javax.swing.SwingWorker<MenuCardData, Void> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel1.this, msg, "Menu load failed", JOptionPane.ERROR_MESSAGE);
                }
            }
        };
    ...
    private void refreshMenuLabels() {
        ...
        if (icon != null) {
            ...
            jLabel3.setText(currentMenuImagePath == null || currentMenuImagePath.isBlank() ? "Image" : currentMenuImagePath);
        }
    }
    ...
    private void addToCart() {
        ...
        fields.set("menuItemId", FirestoreDocuments.stringValue(currentMenuId != null ? currentMenuId : ""));
        ...
        javax.swing.SwingWorker<Void, Void> worker = new javax.swing.SwingWorker<>() {
            ...
            protected void done() {
                try {
                    get();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel1.this, "Added to cart.", "Cart updated", JOptionPane.INFORMATION_MESSAGE);
                } catch (InterruptedException ie) {
                    Thread.currentThread().interrupt();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel1.this, "Cart save interrupted.", "Add to cart failed", JOptionPane.ERROR_MESSAGE);
                } catch (ExecutionException ee) {
                    String msg = ee.getCause() != null ? ee.getCause().getMessage() : ee.getMessage();
                    JOptionPane.showMessageDialog(CustomerShowFoodPanel1.this, msg, "Add to cart failed", JOptionPane.ERROR_MESSAGE);
                } finally {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/barkbites/CustomerDesign/CustomerShowFoodPanel1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new CustomerShowFoodPanel1().setVisible(true));
    }
